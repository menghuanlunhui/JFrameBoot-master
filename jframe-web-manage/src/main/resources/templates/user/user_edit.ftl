...
<div class="ibox-content">
    <form class="form-horizontal" id="userEditForm">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="radio radio-info radio-inline">
                    <input type="radio" name="deleted" id="state1" value="0" ${(user.deleted==null) ?string('',(user.deleted=="0")?string('checked',''))}>
                    <label for="state1">正常</label>
                </div>
                <div class="radio radio-info radio-inline">
                    <input type="radio" name="deleted" id="state2" value="1" ${(user.deleted==null) ?string('',(user.deleted=="1")?string('checked',''))}>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="radio radio-info radio-inline">
                    <input type="radio" name="gender" id="gender1" value="1" ${(user.gender==null) ?string('',(user.gender=="1")?string('checked',''))}>
                    <label for="gender1">男</label>
                </div>
                <div class="radio radio-info radio-inline">
                    <input type="radio" name="gender" id="gender2" value="0" ${(user.gender==null) ?string('',(user.gender=="0")?string('checked',''))}>
