...
public class CountLine {
	...
	public static File dest = new File("/Users/admin/Desktop/result-css.txt");// 存放记录的文件
	public static int counts = 0;// 总行数
	public static String fileType = ".css";// 搜索文件类型

	public static void main(String[] args) {
		// 需要统计的文件夹，不要输入文件
		src = new File("/Users/admin/Desktop/Project/Idea/Mall/src/main/webapp/static/theme");
		try {
